...
t0 = time.time()
mc_pricer = montecarlo.MonteCarlo(model= model, option = option, n_sim = 2**15)
print(mc_pricer.estimate_price(random = 1,confidence = False))
t1 = time.time()
print('Time taken:', t1-t0)
mc_pricer.plot_mc_price()
print(mc_pricer.brute_force_confidence(20,random = 1))
